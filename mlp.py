...
while exit != inp:
    ...
    if inp == strain:
        ...
        print('Program natury problemu klasyfikacji obrazów z wykorzystaniem algorytmu MLP','T - Rozpoczyna uczenie maszyny rozróżniania banana od jabłka na bazie danych treningowych',
              'R - Rozpoczyna właściwy test algorytmu UWAGA jeśli nie uruchomiłeś wcześniej trybu treningowego maszyna może klasyfikować "na ślepo"',
